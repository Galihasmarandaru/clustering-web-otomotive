...
function [idx,dist] = kMeans(minMax,C1,C2,C3)

[a,b] = size(minMax);

n = 1;
[idx(:,n),dist(:,n)] = jarakCosinus(minMax,C1,C2,C3,a);
n = n + 1;
...
for x=1:10
    ...
    [idx(:,n),dist(:,n)] = jarakCosinus(minMax,C1New,C2New,C3New,a);
    n = n + 1;
